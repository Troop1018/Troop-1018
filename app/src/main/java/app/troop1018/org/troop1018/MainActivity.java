...
//    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_chuckbox) {
            fragment = new ChuckCheckFragment();
        } else if (id == R.id.nav_dutchoven) {
            fragment = new DutchOvenFragment();
        } else if (id == R.id.nav_handy_info) {
            fragment = new HandyInfoForCooksFragment();
        } else if (id == R.id.nav_calendar) {
            fragment = new TroopCalendarFragment();
...
//        } else if (id == R.id.nav_send) {
        ...
        if (fragment != null) {
            ...
            ft.replace(R.id.cmain, fragment);
            ft.commit();
        }
